        ...
        <div className='container'>
            ...
            <div className='m-10 flex flex-col md:flex-row'>
              ...
              <div className='flex flex-col '>
                <h1 className='ml-4 font-sen text-4xl font-bold'>Categories</h1>
               ...
               CategoryData.map((item,index)=>(
                <Link href={`/category/${item.slug}`}>
                  ...
                  {/* categori item */}
                    ...
                    <div className='flex flex-col p-5 space-y-3 w-[296px] h-[96px] border-2 border-[#C1C1C3] hover:bg-[#FFD050] m-5'>
...
<div>
                <h4 className='m-4 font-sen text-4xl font-bold '>All Tags</h4>

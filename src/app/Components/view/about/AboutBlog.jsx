    ...
    <div className='container grid grid-cols-1 gap-[121px] py-[91px]'>
        <div className='flex flex-col xl:flex-row xl:items-center xl:justify-between gap-16'>
            ...
            <div className='relative'>
                <div className='w-full h-[300px] lg:w-[624px] lg:h-[480px]'>
                    <Image src='/assets/images/About/abouthero.png' fill objectFit="cover" alt="image"/>

                </div>
                <div className='w-[103px] h-[116px] bg-[#FFD050] rounded-tl-3xl -ml-12 -mt-[400px] absolute hidden xl:block'></div>
        ...
        <div className='relative'>
                ...
                <div className='w-[74px] h-[74px] bg-[#592EA9] rounded-full ml-12 -mt-[40px] absolute hidden xl:block'></div>

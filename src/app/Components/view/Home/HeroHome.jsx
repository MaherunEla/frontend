...
const HeroHome = () => {
  return (
    <section>
        <div className="bg-[url('/assets/images/Home/homebg.png')] bg-cover bg-center bg-no-repeat h-[720px]"> 
        < div className='flex flex-col px-10 py-[128px] space-y-5'>
                ...
                <button className='max-w-[204px] border-2 px-2 py-2 border-[#FFD050] bg-[#FFD050] text-lg font-bold text-[#232536]'>Read More</button>
